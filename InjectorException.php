...
interface InjectorException
{
    ...
    public const M_SHARE_ARGUMENT         = '%s::share() requires a string class name or 
    ...
    public const M_DELEGATE_ARGUMENT      = '%s::delegate expects a valid callable or executable class::method 
