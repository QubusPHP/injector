...
interface InjectorException
{
    ...
    public const M_SHARE_ARGUMENT = '%s::share() requires a string class name or object instance '
    . 'at Argument 1; %s specified';
    ...
    public const M_NON_PUBLIC_CONSTRUCTOR = 'Cannot instantiate a non-public constructor in class %s';
    ...
    public const M_UNDEFINED_PARAM = 'No definition available to provision typeless parameter $%s '
    . 'at position %d in %s(). Injection Chain: %s';
    public const E_DELEGATE_ARGUMENT = 10;
    public const M_DELEGATE_ARGUMENT = '%s::delegate expects a valid callable or executable '
    . 'class::method string at Argument 2%s';
    ...
    public const M_MAKING_FAILED = 'Making %s did not result in an object, instead result is of '
    . 'type \'%s\'';
    public const E_CYCLIC_ALIAS = 13;
    public const M_CYCLIC_ALIAS = 'Cannot alias %s to %s because it would create an alias cycle';
    public const E_INVALID_DEFINITION = 14;
    public const M_INVALID_DEFINITION = 'Class definitions must contain a class name and argument array';
}
